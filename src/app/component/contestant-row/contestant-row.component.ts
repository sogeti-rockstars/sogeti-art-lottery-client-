...
import { AltModalComponent, AltModalService } from 'src/app/service/alt-modal.service';
...
export class ContestantRowComponent implements AltModalComponent {
    ...
    constructor(private modalService: AltModalService) {}
    ...
    openDefaultModal(): void {
        this.modalService.test(ContestantRowComponent);
